...
<!-- //header -->
	...
	<div class="title-section pt-5 text-center">
			...
			<div class="row agile_gallery_grids w3-agile demo">
				<div class="col-md-4 gal-sec">
					<div class="gallery-grid1">
						<a href="#gal1">
						<img src="{{URL::to('fontend/images/g1.jpg')}}" alt=" " class="img-fluid" />
						
						</a>
					</div>
					<div class="gallery-grid1">
						<a href="#gal2">
						<img src="{{URL::to('fontend/images/g2.jpg')}}" alt=" " class="img-fluid" />
						
						</a>
					</div>
					<div class="gallery-grid1">
						<a href="#gal3">
						<img src="{{URL::to('fontend/images/g3.jpg')}}" alt=" " class="img-fluid" />
				...
				<div class="col-md-4 gal-sec">
					<div class="gallery-grid1">
						<a href="#gal4">
						<img src="{{URL::to('fontend/images/g4.jpg')}}" alt=" " class="img-fluid" />
						
						</a>
					</div>
					<div class="gallery-grid1">
						<a href="#gal5">
						<img src="{{URL::to('fontend/images/g5.jpg')}}" alt=" " class="img-fluid" />
						
						</a>
					</div>
					<div class="gallery-grid1">
						<a href="#gal6">
						<img src="{{URL::to('fontend/images/g6.jpg')}}" alt=" " class="img-fluid" />
				...
				<div class="col-md-4 gal-sec">
					<div class="gallery-grid1">
						<a href="#gal7">
						<img src="{{URL::to('fontend/images/g7.jpg')}}" alt=" " class="img-fluid" />
						
						</a>
					</div>
					<div class="gallery-grid1">
						<a href="#gal8">
						<img src="{{URL::to('fontend/images/g8.jpg')}}" alt=" " class="img-fluid" />
						
						</a>
					</div>
					<div class="gallery-grid1">
						<a href="#gal9">
						<img src="{{URL::to('fontend/images/g9.jpg')}}" alt=" " class="img-fluid" />
	 ...
	 <!-- popup-->
        <div id="gal1" class="pop-overlay animate">
            <div class="popup">
        <img src="{{URL::to('fontend/images/g1.jpg')}}" alt="Popup Image" class="img-fluid" />
        ...
        <div id="gal2" class="pop-overlay animate">
            <div class="popup">
                <img src="{{URL::to('fontend/images/g2.jpg')}}" alt="Popup Image" class="img-fluid" />
                <p class="mt-4 editContent">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat dolor.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        ...
        <div id="gal3" class="pop-overlay animate">
            <div class="popup">
                <img src="{{URL::to('fontend/images/g3.jpg')}}" alt="Popup Image" class="img-fluid" />
                <p class="mt-4 editContent">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat dolor.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        ...
        <div id="gal4" class="pop-overlay animate">
            <div class="popup">
            <img src="{{URL::to('fontend/images/g4.jpg')}}" alt="Popup Image" class="img-fluid" />
                <p class="mt-4 editContent">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat dolor.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        ...
        <div id="gal5" class="pop-overlay animate">
            <div class="popup">
                <img src="{{URL::to('fontend/images/g5.jpg')}}" alt="Popup Image" class="img-fluid" />
                <p class="mt-4 editContent">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat dolor.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        ...
        <div id="gal6" class="pop-overlay animate">
            <div class="popup">
                <img src="{{URL::to('fontend/images/g6.jpg')}}" alt="Popup Image" class="img-fluid" />
                <p class="mt-4 editContent">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat dolor.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
  ...
  <!-- popup-->
        <div id="gal7" class="pop-overlay animate">
            <div class="popup">
                <img src="{{URL::to('fontend/images/g7.jpg')}}" alt="Popup Image" class="img-fluid" />
                <p class="mt-4 editContent">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat dolor.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        ...
        <div id="gal8" class="pop-overlay animate">
            <div class="popup">
                <img src="{{URL::to('fontend/images/g8.jpg')}}" alt="Popup Image" class="img-fluid" />
                <p class="mt-4 editContent">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat dolor.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
        ...
        <div id="gal9" class="pop-overlay animate">
            <div class="popup">
                <img src="{{URL::to('fontend/images/g9.jpg')}}" alt="Popup Image" class="img-fluid" />
                <p class="mt-4 editContent">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat dolor.</p>
                <a class="close" href="#gallery">&times;</a>
            </div>
        </div>
