        ...
        <div class="container py-lg-3">
            <div class="row ban_form">
                ...
                <div class="col-lg-5 reg-fom">
                    <img src="{{URL::to('fontend/images/1.jpg')}}" class="img-fluid" alt="">
               ...
               <div class="row middle-grids mt-lg-5 pt-5">
                   <div class="col-lg-6 advantage-grid-info1">
                        <div class="advantage_left1 text-center">
                            <img src="{{URL::to('fontend/images/p1.jpg')}}" class="img-fluid" alt="">
                        </div>
                    </div> 
                 ...
                 <div class="row middle-grids pt-lg-5">
                    ...
                    <div class="col-lg-6 advantage-grid-info1">
                        <div class="advantage_left2 text-center">
                            <img src="{{URL::to('fontend/images/g1.jpg')}}" class="img-fluid" alt="">
                        </div>
                    </div> 
                </div>
            </div>
            ...
            <div class="row mt-md-5 pt-4">
                    ...
                    <div class="feedback-info py-5 px-4">
                        ...
                        <div class="feedback-grids mt-4">
                            <div class="feedback-img">
                                <img src="{{URL::to('fontend/images/te1.jpg')}}" class="img-fluid rounded-circle" alt="" />
                            </div>
                ...
                <div class="col-md-4 item-2">
                    <div class="feedback-info py-5 px-4">
                        ...
                        <div class="feedback-grids mt-4">
                            <div class="feedback-img">
                                <img src="{{URL::to('fontend/images/te3.jpg')}}" class="img-fluid rounded-circle" alt="" />
                            </div>
                            <div class="feedback-img-info">
                                <h5>Olivia Ruth</h5>
                            </div>
                ...
                <div class="col-md-4 item">
                    <div class="feedback-info py-5 px-4">
                        ...
                        <div class="feedback-grids mt-4">
                            <div class="feedback-img">
                                <img src="{{URL::to('fontend/images/te2.jpg')}}" class="img-fluid rounded-circle" alt="" />
                            </div>
                            <div class="feedback-img-info">
                                <h5>Blake Joe</h5>
                            </div>
...
<!--/newsletter-->
                ...
                <div class="row mb-md-4 mb-md-3">
                    <div class="col-lg-3 col-md-6 social-info text-left">
                       <h3 class="tittle1 foot mb-md-5 mb-4 text-white">Get in touch</h3>
                        <p>0926k 4th block building,Dhanmondi, </p>
                        <p class="my-2"> Bangladesh City Dhaka,BD</p>
                        <p class="phone">phone:01797522144</p>
                        <p class="phone my-2">Fax: +02 555 6789</p>
                        <p class="phone">Mail:
                            <a href="mailto:info@example.com">AmitHasanFaysal@example.com</a>
                        </p>
    ...
    <div class="copyright py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-8">      
                    <p class="copy-right mt-2">© 2020 Marrige media. All Rights Reserved | Design by
